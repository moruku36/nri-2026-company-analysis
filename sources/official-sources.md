...
原則として、分析本文ではNRI自身の主張と筆者の解釈を分離する。数値・経営方針・経営陣発言については、可能な限りここに掲載した一次情報へ遡れるようにする。

## 2026年主要資料

| 日付 | 資料 | 種別 | 主な用途 | URL |
|---|---|---|---|---|
| 2026-04-23 | 減損損失の計上および業績予想の修正 | IR / 適時開示 | NRI Australia、Core BTS等の減損、海外事業評価 | https://ir.nri.com/jp/ir/news.html |
| 2026-04-24 | 2026年3月期 決算関連資料 | IR / 決算 | FY2025実績、海外減損、FY2026計画 | https://ir.nri.com/jp/ir/library/financial.html |
| 2026-04-24 | 中期経営計画（2026-2028） | IR / 経営計画 | 2028目標、AX、AI投資、セキュリティ、海外方針、財務方針 | https://ir.nri.com/jp/ir/library/businessplan.html |
| 2026-04-24 | 2026年3月期決算および中期経営計画説明会 質疑応答 | IR / Q&A | 営業利益2,000億円の考え方、Anthropic、海外、AI関連売上、自社株買い | https://ir.nri.com/jp/ir/library/financial.html |
| 2026-05-15 | 中期経営計画フォローアップ説明会 | IR / 戦略説明 | AX市場、NRIのAI戦略、コンソリューション/プラットフォーム戦略 | https://ir.nri.com/jp/ir/library/businessplan.html |
...
| NRI 中期経営計画 | 中計本編・フォローアップ資料 | https://ir.nri.com/jp/ir/library/businessplan.html |
| NRI IR スモールミーティング | 機関投資家向け詳細Q&A | https://ir.nri.com/jp/ir/library/smallmtg.html |
...
2026年3月期の会計上の営業利益は、海外事業ののれん等減損損失の影響を受けて**582億円**。

一方、中期経営計画では今後の収益力を比較するため、海外事業の減損等影響を除いた**1,566億円**を2025年度の比較基準として表示している箇所がある。

この2つを混同しないこと。

### AI関連売上

NRIによれば、顧客向けのAI導入・AI基盤・AIを活用するシステム刷新等をAI関連売上として扱う一方、NRI自身が開発工程でAIを使って生産性を上げても、その案件を自動的にAI関連売上へ含めるわけではない。

ただしAIがほぼ全案件へ組み込まれる将来は、KPIとしての境界が曖昧になる可能性がある。

## Research policy

- 一次情報を最優先する。
- NRI自身の予測・目標は「事実」ではなく「会社計画」として扱う。
- NRIによるAI性能評価や自社サービス評価は、第三者評価と分ける。
- 外部報道・証券会社・競合・SNS等は `external-sources.md` に分離する。
- 情報が更新された場合は、取得日と変更点をresearch logへ残す。
